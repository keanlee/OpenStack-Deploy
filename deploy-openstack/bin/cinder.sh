...
echo $BLUE Starting openstack-cinder-api.service openstack-cinder-scheduler.service  openstack-cinder-backup.service
...
#RabbitMQ
    ...
    sed -i "/rabbitmq-config/a\transport_url = rabbit://openstack:RABBIT_PASS@rabbit1:5672,openstack:RABBIT_PASS@rabbit2:5672,openstack:RABBIT_PASS@rabbit3:5672" /etc/cinder/cinder.conf
    sed -i "s/RABBIT_PASS/$RABBIT_PASS/g" /etc/cinder/cinder.conf
